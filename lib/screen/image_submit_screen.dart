...
class _ImageSubmitScreenState extends State<ImageSubmitScreen> {
  ...
  Future<void> setImages() async {
    ...
    var snapshot = await FirebaseStorage.instance
        .ref("UI_Submit_Batch_$myBatch")
        .child(
            "${myName}_${myBatchID}_${DateTime.now().microsecondsSinceEpoch.toString()}")
                      ...
                      child: GestureDetector(
                        onTap: () async {
                            ...
                            if (image != null) {
                              ...
                              showToast(
                                  "Please Select Image First", Colors.red);
                              setState(() {
                                _isTapped = false;
                              });
                            }
